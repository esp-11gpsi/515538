...
function create_exercices () {
    ...
    create_exercice_mvdir 2
    create_exercice_ren 3 
    create_exercice_mkdir 4
    create_exercice_rm 5 "Apagar este ficheiro"
    create_exercice_mv 6 "Mudar o nome deste ficheiro para 'ficheiro renomeado'"
    create_exercice_rmdir 7
